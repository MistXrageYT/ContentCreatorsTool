...
All notable changes to **ContentCreatorsTool** will be documented in this file.
...
ContentCreatorsTool has officially graduated from beta and is now considered stable for Minecraft 26.2.
...
* Updated all bundled mods
* Updated resource packs
* Updated shaders
* Improved compatibility and overall stability

### Changed

* General optimization improvements
* Better compatibility with the Minecraft 26.2 mod ecosystem

### Removed

* Krypton *(temporarily)*
* FastQuit *(temporarily)*
* Fabrishot *(temporarily)*
* Cherished Worlds *(temporarily)*
...
* Re-enabled Flashback
* Re-enabled Mouse Wheelie
* Re-enabled Very Many Players (Fabric)
* Re-enabled Concurrent Chunk Management Engine (Fabric)
* Re-enabled ImmediatelyFast
...
* Re-enabled Cubes Without Borders
* Re-enabled Wavey Capes
...
* Re-enabled Better Mount HUD
* Re-enabled Visuality
* Re-enabled 3D Skin Layers
* Re-enabled Not Enough Animations
* Re-enabled Spark
* Re-enabled Status Effect Bars
* Re-enabled WorldEdit

### Updated

* Updated bundled mods
* Updated resource packs
...
* New custom resource packs by MistXRage

### Updated

* Updated base game to Minecraft 26.2
* Updated a large number of mods
* Updated resource packs

### Changed

* Major compatibility improvements
* Initial 26.2 beta release
